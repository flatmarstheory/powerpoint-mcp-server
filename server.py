...
Built with FastMCP and all Office-PowerPoint-MCP-Server features.
"""
import os
...
# ---- Register All PowerPoint Tools ----

# Register all tool modules with FastMCP app
register_presentation_tools(
    app,
    presentations,
...
def get_server_info() -> Dict:
    """Get comprehensive information about the PowerPoint MCP server capabilities."""
    return {
        "name": "PowerPoint MCP Server - ChukMCP Edition",
        "version": "2.2.0",
        "architecture": "ChukMCPServer",
        "total_tools": 32,
        ...
        "improvements": [
            "Built on ChukMCPServer architecture",
        ...
        "enhanced_features": [
            ...
            "Slide Transitions - Basic transition management"
        ]
    }
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="PowerPoint MCP Server - FastMCP Edition")
